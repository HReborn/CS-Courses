...
# Progress sheet with dates

To keep track and share my own (Reborn) personal progress, i'll share my spreadsheet with how long i took for each class, when i completed it and when i started it. I really do hope you take this course too.
<a href="https://docs.google.com/spreadsheets/d/1d3vH_sLD7jhs58UqPOC94KWGvSX42hnEnm7tD-gmaKs/edit?usp=sharing">Sheets<a/>
